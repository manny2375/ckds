...
export default function Story({ onVisible }: StoryProps) {
  ...
  return (
    <>
      ...
      >
        <div className="w-full px-6 sm:px-10 md:px-12 laptop:px-8 desktop:px-24 py-8 sm:py-12 laptop:py-8 flex">
          <div className="w-full max-w-7xl mx-auto flex flex-col">
            <div className="flex items-center mb-12 laptop:mb-10 desktop:mb-16">
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
              ...
              <div className="lg:w-2/3">
                <div className="grid sm:grid-cols-2 gap-x-8 sm:gap-x-12 gap-y-8 sm:gap-y-10">
                <div>
                  <h4 className="text-lg sm:text-xl font-light mb-3" style={{ color: '#755C53' }}>Elevate Human Experiences</h4>
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-light mb-3" style={{ color: '#755C53' }}>Create Opportunity & Connection</h4>
                  <p className="text-gray-600 leading-relaxed text-sm">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-light mb-3" style={{ color: '#755C53' }}>Convey Our Clients' Story & Brand</h4>
                  <p className="text-gray-600 leading-relaxed text-sm">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-light mb-3" style={{ color: '#755C53' }}>Disguise Function Within Fashion</h4>
                  <p className="text-gray-600 leading-relaxed text-sm">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-light mb-3" style={{ color: '#755C53' }}>Wellness-Focused</h4>
                  <p className="text-gray-600 leading-relaxed text-sm">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-light mb-3" style={{ color: '#755C53' }}>Innovate & Shape Culture</h4>
                  <p className="text-gray-600 leading-relaxed text-sm">
