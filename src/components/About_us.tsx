          ...
          <div className="w-full max-w-7xl mx-auto flex flex-col laptop:justify-center">
            ...
            <div className="flex flex-col laptop:flex-row gap-8 laptop:gap-8 desktop:gap-16">
              ...
              <div className="laptop:w-3/4 desktop:w-2/3">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl laptop:text-base desktop:text-xl font-light mb-3 laptop:mb-2" style={{ color: '#755C53' }}>Create Opportunity & Connection</h4>
                  <p className="text-gray-600 leading-relaxed text-sm laptop:text-xs desktop:text-sm">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl laptop:text-base desktop:text-xl font-light mb-3 laptop:mb-2" style={{ color: '#755C53' }}>Convey Our Clients' Story & Brand</h4>
                  <p className="text-gray-600 leading-relaxed text-sm laptop:text-xs desktop:text-sm">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl laptop:text-base desktop:text-xl font-light mb-3 laptop:mb-2" style={{ color: '#755C53' }}>Disguise Function Within Fashion</h4>
                  <p className="text-gray-600 leading-relaxed text-sm laptop:text-xs desktop:text-sm">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl laptop:text-base desktop:text-xl font-light mb-3 laptop:mb-2" style={{ color: '#755C53' }}>Wellness-Focused</h4>
                  <p className="text-gray-600 leading-relaxed text-sm laptop:text-xs desktop:text-sm">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl laptop:text-base desktop:text-xl font-light mb-3 laptop:mb-2" style={{ color: '#755C53' }}>Innovate & Shape Culture</h4>
                  <p className="text-gray-600 leading-relaxed text-sm laptop:text-xs desktop:text-sm">
