  ...
  return (
    ...
    >
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-10 laptop:px-8 desktop:px-16 py-8 sm:py-12 laptop:py-0">
        ...
        <h2 id="cheryl-heading" className="text-3xl sm:text-4xl laptop:text-2xl desktop:text-4xl font-light leading-tight mb-4 laptop:mb-2" style={{ fontFamily: 'Georgia, serif' }}>
          Meet Cheryl Kaye
        </h2>
        <div className="w-24 h-px bg-gradient-to-r from-black to-transparent mb-8 laptop:mb-4 desktop:mb-10"></div>

        <div className="grid laptop:grid-cols-[260px,1fr] desktop:grid-cols-[340px,1fr] gap-6 laptop:gap-6 desktop:gap-12 items-start">
          ...
          <div className="space-y-4 laptop:space-y-2 desktop:space-y-5 text-[13px] laptop:text-[11px] desktop:text-[14px] leading-[1.7] laptop:leading-[1.5] desktop:leading-[1.7] text-black">
            <p>
