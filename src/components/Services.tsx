  ...
  return (
    ...
    >
      <div className="w-full h-full grid laptop:grid-cols-2 laptop:overflow-hidden">
        <div className="px-4 sm:px-6 md:px-8 laptop:px-4 desktop:px-12 py-8 sm:py-12 laptop:py-1 desktop:py-14 laptop:pt-0 desktop:pt-20 flex flex-col laptop:justify-start desktop:justify-start laptop:h-screen laptop:overflow-y-auto laptop:pb-4 relative">
          ...
          <h2 id="services-heading" className="text-3xl sm:text-4xl laptop:text-[13px] desktop:text-4xl font-light leading-tight mb-4 laptop:mb-0 laptop:mt-2 desktop:mb-4 desktop:mt-0">
            Our Services
          </h2>
          <div className="w-24 h-px bg-gradient-to-r from-black to-transparent mb-6 laptop:mb-0 desktop:mb-8"></div>

          <div className="space-y-4 laptop:space-y-0 desktop:space-y-6 text-sm laptop:text-[7.5px] desktop:text-[15px] text-gray-900 leading-relaxed laptop:leading-[1.1] mb-8 laptop:mb-0 desktop:mb-10">
            <p>
          ...
          <div className="mb-8 laptop:mb-0 desktop:mb-10">
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-2.5 laptop:gap-x-2 laptop:gap-y-0 text-sm laptop:text-[7.5px] laptop:leading-[1.15] desktop:text-[15px] text-gray-900">
          ...
          <p className="text-sm laptop:text-[7.5px] desktop:text-[15px] text-gray-900 leading-relaxed laptop:leading-[1.1] laptop:mt-0">
