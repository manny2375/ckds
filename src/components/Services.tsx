  ...
  return (
    ...
    >
      <div className="w-full h-full grid laptop:grid-cols-2">
        <div className="px-4 sm:px-6 md:px-8 laptop:px-6 desktop:px-12 py-8 sm:py-12 laptop:py-8 desktop:py-16 laptop:pt-10 desktop:pt-24 flex flex-col justify-start laptop:overflow-y-auto laptop:max-h-screen">
          <div className="text-xs sm:text-sm tracking-widest text-gray-400 mb-3 laptop:mb-2 sm:mb-6" aria-hidden="true">CHAPTER 3 — OUR SERVICES</div>

          <h2 id="services-heading" className="text-3xl sm:text-4xl laptop:text-2xl desktop:text-4xl font-light leading-tight mb-4 laptop:mb-3">
            Our Services
          </h2>
          <div className="w-24 h-px bg-gradient-to-r from-black to-transparent mb-6 laptop:mb-4"></div>

          <div className="space-y-4 laptop:space-y-3 desktop:space-y-6 text-sm laptop:text-[12px] desktop:text-[15px] text-gray-900 leading-relaxed mb-8 laptop:mb-6 desktop:mb-10">
            <p>
          ...
          <div className="mb-8 laptop:mb-6 desktop:mb-10">
            <h3 className="text-base laptop:text-sm desktop:text-lg font-semibold mb-4 laptop:mb-3 desktop:mb-6">Our services include:</h3>
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-2.5 laptop:gap-y-2 text-sm laptop:text-[12px] desktop:text-[15px] text-gray-900">
          ...
          <p className="text-sm laptop:text-[12px] desktop:text-[15px] text-gray-900 leading-relaxed laptop:pb-4">
