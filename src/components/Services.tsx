  ...
  return (
    ...
    >
      <div className="w-full h-full grid laptop:grid-cols-2">
        <div className="px-4 sm:px-6 md:px-8 laptop:px-10 desktop:px-12 py-8 sm:py-12 laptop:py-14 desktop:py-16 laptop:pt-20 desktop:pt-24 flex flex-col justify-start">
          <div className="text-xs sm:text-sm tracking-widest text-gray-400 mb-4 sm:mb-6" aria-hidden="true">CHAPTER 3 — OUR SERVICES</div>

          <h2 id="services-heading" className="text-3xl sm:text-4xl laptop:text-3xl desktop:text-4xl font-light leading-tight mb-4">
            Our Services
          </h2>
          <div className="w-24 h-px bg-gradient-to-r from-black to-transparent mb-8"></div>

          <div className="space-y-6 text-sm laptop:text-[14px] desktop:text-[15px] text-gray-900 leading-relaxed mb-10">
            <p>
          ...
          <div className="mb-10">
            <h3 className="text-base laptop:text-base desktop:text-lg font-semibold mb-6">Our services include:</h3>
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-2.5 text-sm laptop:text-[14px] desktop:text-[15px] text-gray-900">
          ...
          <p className="text-sm laptop:text-[14px] desktop:text-[15px] text-gray-900 leading-relaxed">
