    ...
    >
      <div className="w-full h-full grid laptop:grid-cols-2">
        <div className="px-4 sm:px-6 md:px-8 laptop:px-6 desktop:px-12 py-8 sm:py-12 laptop:py-0 desktop:py-14 laptop:pt-0 desktop:pt-20 flex flex-col laptop:justify-center desktop:justify-start laptop:h-full">
          ...
          <div className="w-24 h-px bg-gradient-to-r from-black to-transparent mb-6 laptop:mb-3 desktop:mb-8"></div>

          <div className="space-y-4 laptop:space-y-2 desktop:space-y-6 text-sm laptop:text-[11px] desktop:text-[15px] text-gray-900 leading-relaxed laptop:leading-snug mb-8 laptop:mb-4 desktop:mb-10">
            <p>
          ...
          <div className="mb-8 laptop:mb-4 desktop:mb-10">
            <h3 className="text-base laptop:text-sm desktop:text-lg font-semibold mb-4 laptop:mb-2 desktop:mb-6">Our services include:</h3>
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-2.5 laptop:gap-y-1.5 text-sm laptop:text-[11px] desktop:text-[15px] text-gray-900">
          ...
          <p className="text-sm laptop:text-[11px] desktop:text-[15px] text-gray-900 leading-relaxed laptop:leading-snug">
