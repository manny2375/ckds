      ...
      <div className="w-full h-full grid laptop:grid-cols-2 laptop:overflow-hidden">
        <div className="px-4 sm:px-6 md:px-8 laptop:px-4 desktop:px-12 py-8 sm:py-12 laptop:py-4 desktop:py-14 laptop:pt-1 desktop:pt-20 flex flex-col laptop:justify-start desktop:justify-start laptop:h-screen laptop:overflow-hidden relative">
          ...
          <div className="mb-8 laptop:mb-0 desktop:mb-10">
            ...
            <div className="grid sm:grid-cols-2 gap-x-8 gap-y-2.5 laptop:gap-x-2 laptop:gap-y-0 text-sm laptop:text-[8px] laptop:leading-[1.3] desktop:text-[15px] text-gray-900">
          ...
          <p className="text-sm laptop:text-[8px] desktop:text-[15px] text-gray-900 leading-relaxed laptop:leading-[1.2] laptop:mt-0.5">
